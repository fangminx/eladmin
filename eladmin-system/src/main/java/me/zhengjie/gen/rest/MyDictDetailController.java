...
@Api(tags = "系统：字典详情管理")
@RequestMapping("/api/mydictDetail")
public class MyDictDetailController {

    private final MyDictDetailService dictDetailService;
    private static final String ENTITY_NAME = "mydictDetail";

    @Log("查询字典详情")
    @ApiOperation("查询字典详情")
    @GetMapping
    public ResponseEntity<Object> query(MyDictDetailQueryCriteria criteria,
    ...
    public ResponseEntity<Object> getDictDetailMaps(@RequestParam String dictName){
        ...
        Map<String, List<MyDictDetailDto>> dictMap = new HashMap<>(16);
